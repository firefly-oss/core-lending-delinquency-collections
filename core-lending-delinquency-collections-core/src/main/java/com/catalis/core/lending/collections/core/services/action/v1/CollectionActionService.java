...
public interface CollectionActionService {
     ...
     */
    Mono<PaginationResponse<CollectionActionDTO>> findAll(Long collectionCaseId,
     ...
     */
    Mono<CollectionActionDTO> create(Long collectionCaseId, CollectionActionDTO dto);
     ...
     */
    Mono<CollectionActionDTO> getById(Long collectionCaseId, Long actionId);
     ...
     */
    Mono<CollectionActionDTO> update(Long collectionCaseId, Long actionId, CollectionActionDTO dto);
     ...
     */
    Mono<Void> delete(Long collectionCaseId, Long actionId);
}