...
public interface CollectionEscalationService {
     ...
     */
    Mono<PaginationResponse<CollectionEscalationDTO>> findAll(Long collectionCaseId,
     ...
     */
    Mono<CollectionEscalationDTO> create(Long collectionCaseId, CollectionEscalationDTO dto);
     ...
     */
    Mono<CollectionEscalationDTO> getById(Long collectionCaseId, Long escalationId);
     ...
     */
    Mono<CollectionEscalationDTO> update(Long collectionCaseId, Long escalationId, CollectionEscalationDTO dto);
     ...
     */
    Mono<Void> delete(Long collectionCaseId, Long escalationId);
}
